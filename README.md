...
Каждый элемент при вставке платит 1 монетку за себя и 1 монетку за возможные будущие слияния. Когда два дерева сливаются - оплачивается из кредита одного из них. Всего за n вставок - O(n) монеток. Также можно провести аналогию с оценкой бинарного счётчика, получится тоже O(n).
