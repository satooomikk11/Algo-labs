...
3. make test - сгенерировать тесты и запустить тестирование (если тесты уже готовы, можно просто запустить тестирование ./tester)
4. make plot - построить графики по результатам тестирования
